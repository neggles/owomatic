...
class InvalidGuild(Exception):
    """
    Thrown when a user is attempting something, but is not in the correct guild.
    """

    def __init__(self, message="This command can only be used in authorized servers."):
        self.message = message
        super().__init__(self.message)
